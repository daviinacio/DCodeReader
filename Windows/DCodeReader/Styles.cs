...
namespace DCodeReader {
    abstract class Styles {
        ...
        public static Theme Dark = new Theme(ColorTranslator.FromHtml(/*"#103933""#334444"*/"#222222"), Color.FromArgb(0xffffff), Color.MediumAquamarine, Color.White, new HighLight_Char [] {
            new HighLight_Char('{', Color.Blue)
